...
// declare variable 'counter' and use a DOM method to target the 'h2' tag with the id of 'countdown'
let counter = document.getElementById('countdown');
// set the 'counter' variable '.innerHTML' property to the value of 'diff' to display the days till christmas
